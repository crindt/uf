...
class SacogHardwoodFeatureResource(FeatureResource):
    """
        Resource representing Sacog vernal pool layer
    """
    geography = ToOneField(GeographyResource, 'geography', full=True)
    ...
    class Meta(FeatureResource.Meta):
        ...
        excludes = FeatureResource.Meta.excludes
        always_return_data = False
        resource_name = 'sacog_hardwood_feature'
        queryset = SacogHardwoodFeature.objects.all() # Just for model_class initialization, should never be called
