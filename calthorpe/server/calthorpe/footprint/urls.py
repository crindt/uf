...
from footprint.initialization.fixtures.client.sacog.resource.sacog_resource import SacogStreamFeatureResource, SacogWetlandFeatureResource, SacogVernalPoolFeatureResource, SacogExistingLandUseParcelFeatureResource, SacogHardwoodFeatureResource
from footprint.initialization.fixtures.client.scag__irvine.resource.scag__irvine_resource import ScagExistingLandUseParcelFeatureResource, ScagGeneralPlanParcelFeatureResource, ScagSpzFeatureResource
